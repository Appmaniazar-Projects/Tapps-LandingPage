    ...
    <FluidBackground variant="challenge" className="relative overflow-hidden py-20 md:py-28">
      <div className="container mx-auto px-4">
        ...
        <div className="mt-16 grid gap-8 md:grid-cols-3">
          <div className="group rounded-3xl border border-white/15 bg-white/10 p-8 shadow-sm backdrop-blur-sm transition-all hover:border-white/25 hover:bg-white/15">
            <div className="mb-6 flex h-14 w-14 items-center justify-center rounded-2xl bg-white/10 text-white transition-colors group-hover:bg-white/15">
              <AlertTriangle className="h-7 w-7" />
            </div>
            <h3 className="text-xl font-semibold text-white">Limited Dam Information</h3>
          ...
          <div className="group rounded-3xl border border-white/15 bg-white/10 p-8 shadow-sm backdrop-blur-sm transition-all hover:border-white/25 hover:bg-white/15">
            ...
            <h3 className="text-xl font-semibold text-white">Declining Reserves</h3>
            <p className="mt-3 text-white/80">
          ...
          <div className="group rounded-3xl border border-white/15 bg-white/10 p-8 shadow-sm backdrop-blur-sm transition-all hover:border-white/25 hover:bg-white/15">
            ...
            <h3 className="text-xl font-semibold text-white">Lack of Awareness</h3>
            <p className="mt-3 text-white/80">
